...
import com.leapfrog.ulsp.UI.Users.*;
 ...
 * @author AM3ET
 */
public class CategorySearcholdUI extends javax.swing.JFrame {
     ...
     */
    public CategorySearcholdUI() {
        initComponents();
    }

    public CategorySearcholdUI(String name) {
        initComponents();
        this.name = name;
        try {
