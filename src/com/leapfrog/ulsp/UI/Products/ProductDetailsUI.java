...
import com.leapfrog.ulsp.UI.Users.UserDetailAddUI;
import com.leapfrog.ulsp.UI.Users.UserSearchUI;
import com.leapfrog.ulsp.UI.Users.UserUpdateUI;
 ...
 * @author AM3ET
 */
public class ProductDetailsUI extends javax.swing.JFrame {
    ...
    public ProductDetailsUI() {
        initComponents();
        String[] columns = {"ID", "Name", "Description", "Quantity","Cost Price", "Selling Price", "Status"};
        try {
            tblUser.setModel(new userDetailsModule(columns, productDAO.getAll()));
    ...
    private void addButtonClick(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonClick
        new ProductDetailAddUI().setVisible(true);
    ...
    private void editButtonClick(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonClick
        ...
        new ProductUpdateUI(id).setVisible(true);
    ...
    private void searchButtonClick(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonClick
        ...
        new ProductSearchUI(name).setVisible(true);
    ...
    private class userDetailsModule extends AbstractTableModel {
        ...
        public userDetailsModule(String[] columns, List<Product> productList) {
