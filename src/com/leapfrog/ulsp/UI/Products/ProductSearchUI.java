 ...
 * @author AM3ET
 */
public class ProductSearchUI extends javax.swing.JFrame {
    ...
    public ProductSearchUI(String name) {
        initComponents();
        this.name = name;
        try {
    ...
    private void initComponents() {
        ...
        btnClose.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        ...
        lblNewUser.setText("Details of Product");
