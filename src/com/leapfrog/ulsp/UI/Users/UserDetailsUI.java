...
public class UserDetailsUI extends javax.swing.JFrame {
    ...
    public UserDetailsUI() {
        initComponents();
        String[] columns = {"ID", "Name", "Password", "Email", "Status"};
        try {
            tblUser.setModel(new userDetailsModule(columns, userDAO.getAll()));
    ...
    private void addButtonClick(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonClick
        new UserDetailAddUI().setVisible(true);
    ...
    private void editButtonClick(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonClick
        ...
        new UserUpdateUI(id).setVisible(true);
    ...
    private void searchButtonClick(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonClick
        ...
        new UserSearchUI(name).setVisible(true);
    ...
    private class userDetailsModule extends AbstractTableModel {
        ...
        public userDetailsModule(String[] columns, List<User> userList) {
