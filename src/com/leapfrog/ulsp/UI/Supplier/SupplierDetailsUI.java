 ...
 * @author AM3ET
 */
public class SupplierDetailsUI extends javax.swing.JFrame {
    ...
    public SupplierDetailsUI() {
        initComponents();
        String[] columns = {"ID", "Name","Address", "Email", "Contact", "Status"};
        try {
            tblUser.setModel(new userDetailsModule(columns, supplierDAO.getAll()));
    ...
    private void addButtonClick(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonClick
        new SupplierDetailAddUI().setVisible(true);
    ...
    private void editButtonClick(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonClick
        ...
        new SupplierUpdateUI(id).setVisible(true);
    ...
    private void searchButtonClick(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonClick
        ...
        new SupplierSearchUI(name).setVisible(true);
    ...
    private class userDetailsModule extends AbstractTableModel {
        ...
        public userDetailsModule(String[] columns, List<Supplier> supplierList) {
